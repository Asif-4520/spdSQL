...
import { importTables } from "../lib/db";
import {
    DEMO_TABLES,
    TABLE_CATEGORIES,
    TABLE_PRESETS,
...
function DemoData() {
    ...
    return (
        <div className="grid md grid-rows-[90px_80px_1fr_60px] h-full pl-4 p-3 overflow-hidden">
            ...
            <div className="bottom-0 bg-(--bg-main) pt-4 border-t border-(--border-color) mt-4">
