import { Play, Loader2, Sun, Moon } from 'lucide-react';
...
function NavBar() {
    ...
    const { resolvedTheme, toggleTheme, isVertical, setIsVertical } =
        useSettingsStore();
    ...
    return (
        ...
        >
            <div className='flex items-center gap-1'>
                <SQLioLogo size={28} className='mr-2 hidden md:block' />
            ...
            <div className='flex items-center gap-3'>
                <button
                    onClick={toggleTheme}
                    className='p-2 rounded-lg hover:bg-(--bg-activity-bar) transition-colors'
                >
                    {resolvedTheme === 'dark' ? (
                        <Sun size={18} />
                    ) : (
